...
class Distributor extends StatefulWidget {
  const Distributor({Key? key, required this.item_models}) : super(key: key);
          ...
          itemBuilder: (context, index){
            return InkWell(
              onTap:(){
                ...
                Navigator.pop(context,widget.item_models[index].company_name );
              ...
              child: Padding(
                ...
                child: Card(
                  child: ListTile(
                    ...
                    title: Text("${widget.item_models[index].company_name}"),
                  ),
                ),
              ),
            );
