...
import 'package:nsuqo/pages/wholesalersproductlist/widgets/wholesalersproducttile.dart';
...
//  old code saved in comment below
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: (){
                  ...
                  Navigator.of(context).push(
                      MaterialPageRoute
                        (builder: (context)=>Wholesaler_Product_List(wholesaler_id: widget.wholesaler_id,)));
              ...
              InkWell(
                ...
                onTap: () async {
                  ...
                  Navigator.of(context).push(
                      MaterialPageRoute
                        (builder: (context)=>Retailers_who_can_view(wholesaler_id:  widget.wholesaler_id,))
