...
class Account_Approval_WholeSaler extends StatefulWidget {
  const Account_Approval_WholeSaler({Key? key, required this.email_val}) : super(key: key);
  final String email_val;

  @override
  State<Account_Approval_WholeSaler> createState() => _Account_Approval_WholeSalerState();
}

class _Account_Approval_WholeSalerState extends State<Account_Approval_WholeSaler> {
